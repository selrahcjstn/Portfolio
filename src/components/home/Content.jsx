    ...
    return (
        <>
            ...
            <div>
                ...
                <p className="text-[#e6e6e6] text-[14px] font-light sm:px-0 max-w-[700px] sm:min-w-0 sm:mr-10 md:text-[14px] md:min-w-[3rem]  lg:m-0 lg:text-[16px] xl:text-[18px] leading-relaxed tracking-wide">
                    {paragraph}
                </p>
